...
class Option(models.Model):
    ...
    title = models.ForeignKey(
        OptionTitle, related_name="option_title", on_delete=models.CASCADE
    )
...
class InspectionCategory(models.Model):
    category = models.ForeignKey(
        Category,
        related_name="inspection_category",
    ...
    inspection_form = models.ForeignKey(
        InspectionForm,
        related_name="inspection_form_category",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
...
class Question(models.Model):
    ...
    category = models.ForeignKey(
        ...
        related_name="inspection_category_question",
        null=True,
        blank=True,
    )
    ...
    answer_type = models.CharField(
        max_length=30, choices=AnswerType, null=True, blank=True
    )
    answer_priority = models.CharField(
        choices=AnswerPriority, default="N/A", max_length=50, null=True, blank=True
    )
...
class Answer(models.Model):
    ...
    answer_priority = models.CharField(
        choices=AnswerPriority, default="Normal", max_length=50, null=True, blank=True
    )
    comment = models.TextField(null=True, blank=True)
